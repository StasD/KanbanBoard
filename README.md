...
**NEW (3 Feb 2026):** Implemented elements of Event Driven Architecture using [RabbitMQ](https://www.rabbitmq.com) message broker paired with [Rebus](https://github.com/rebus-org/Rebus) library to send email notifications to users assigned to Kanban Tasks. Those messages can be seen in [smtp4dev's](https://github.com/rnwood/smtp4dev) web interface at [http://127.0.0.1:8180](http://127.0.0.1:8180).
